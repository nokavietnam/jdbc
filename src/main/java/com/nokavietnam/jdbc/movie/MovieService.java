...
import com.nokavietnam.jdbc.exception.NotFoundException;
...
public class MovieService {
    ...
    public void deleteMovie(Integer id) {
        ...
        movies.ifPresentOrElse(movie -> {
            ...
            throw new NotFoundException(String.format("Movie with id %s notfound", id));
        });
    }
